  ...
  useEffect(() => {
    ...
    const config: KeybindingsConfig = {
      global: {
        ...
        fullscreenTimeline: get(
          'editor.keybindings.global.fullscreenTimeline',
          defaultKeybindings.global.fullscreenTimeline,
        ),
        fullscreenPreview: get(
          'editor.keybindings.global.fullscreenPreview',
          defaultKeybindings.global.fullscreenPreview,
        ),
        fullscreenNavigator: get(
          'editor.keybindings.global.fullscreenNavigator',
          defaultKeybindings.global.fullscreenNavigator,
        ),
        saveProject: get('editor.keybindings.global.saveProject', defaultKeybindings.global.saveProject),
        saveProjectWithoutTask: get(
          'editor.keybindings.global.saveProjectWithoutTask',
          defaultKeybindings.global.saveProjectWithoutTask,
        ),
        ...
        openCommandPalette: get(
          'editor.keybindings.global.openCommandPalette',
          defaultKeybindings.global.openCommandPalette,
        ),
      ...
      canvas: {
        ...
        toolPan: get('editor.keybindings.canvas.toolPan', defaultKeybindings.canvas.toolPan),
        toolScale: get('editor.keybindings.canvas.toolScale', defaultKeybindings.canvas.toolScale),
        toolRotate: get('editor.keybindings.canvas.toolRotate', defaultKeybindings.canvas.toolRotate),
        toolTransform: get('editor.keybindings.canvas.toolTransform', defaultKeybindings.canvas.toolTransform),
        ...
        toggleCenterLines: get(
          'editor.keybindings.canvas.toggleCenterLines',
          defaultKeybindings.canvas.toggleCenterLines,
        ),
      ...
      timeline: {
        ...
        duplicateKeyframe: get(
          'editor.keybindings.timeline.duplicateKeyframe',
          defaultKeybindings.timeline.duplicateKeyframe,
        ),
      },
      navigator: {
