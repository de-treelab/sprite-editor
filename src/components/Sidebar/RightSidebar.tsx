...
export const RightSidebar = () => {
  ...
  const handleRemoveLayer = () => {
    ...
    useHistoryStore.getState().push({
      label: 'Delete layer',
      undo: () => {
        // Re-insert at original position by adding then reordering
  ...
  // Register navigator-scoped commands
  ...
  return (
    <div
      className="w-64 shrink-0 bg-slate-800 border-l border-slate-700 flex flex-col focus:outline-none focus:ring-2 focus:ring-indigo-500"
      tabIndex={0}
